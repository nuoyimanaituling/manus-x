...
services:
  frontend:
    image: dockerdockerdockerxzw/manus-frontend
    ports:
      - "5173:80"
    depends_on:
      - backend
  ...
  backend:
    image: dockerdockerdockerxzw/manus-backend
    depends_on:
      - sandbox
    restart: unless-stopped
    volumes:
    ...
    environment:
      ...
      - SANDBOX_IMAGE=dockerdockerdockerxzw/manus-sandbox
  ...
  sandbox:
    image: dockerdockerdockerxzw/manus-sandbox
