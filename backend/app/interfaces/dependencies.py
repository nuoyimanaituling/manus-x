...
from app.infrastructure.repositories.mongo_scheduled_task_repository import (
    MongoScheduledTaskRepository,
    MongoScheduledTaskExecutionRepository
)
...
def get_scheduler_service() -> SchedulerService:
    ...
    logger.info("Creating SchedulerService instance")

    task_repository = MongoScheduledTaskRepository()
    execution_repository = MongoScheduledTaskExecutionRepository()
    ...
    scheduler_service.set_agent_service(get_agent_service())

    # Set email service for notifications
    scheduler_service.set_email_service(get_email_service())
...
def get_scheduled_task_service() -> ScheduledTaskService:
    """Get scheduled task service instance"""
    logger.info("Creating ScheduledTaskService instance")
    ...
    # Set scheduled_task_service in agent_service to enable scheduled task tool
    get_agent_service().set_scheduled_task_service(scheduled_task_service)
