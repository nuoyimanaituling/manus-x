...
class AgentService:
    def __init__(
        ...
        self._scheduled_task_service = None
    ...
    def set_scheduled_task_service(self, scheduled_task_service) -> None:
        """Set scheduled task service (called after initialization to avoid circular dependency)"""
        self._scheduled_task_service = scheduled_task_service
        self._agent_domain_service._scheduled_task_service = scheduled_task_service
        logger.info("ScheduledTaskService set in AgentService")
